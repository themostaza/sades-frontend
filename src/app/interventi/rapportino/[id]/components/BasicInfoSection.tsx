        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          {canEditBasicFields ? (
            <input
              ...
              onChange={(e) =>
                onWorkHoursChange(normalizeDecimalInput(e.target.value))
              }
        ...
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          {canEditBasicFields ? (
            <input
              ...
              onChange={(e) =>
                onTravelHoursChange(normalizeDecimalInput(e.target.value))
              }
              onFocus={(e) => e.target.select()}
              onClick={(e) => e.currentTarget.select()}
              inputMode="decimal"
          ...
          {showNotesField ? (
            canEditBasicFields ? (
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border-2 border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-gray-900 bg-white"
            ...
            <div className="bg-white border border-blue-200 rounded-lg p-4 text-center">
              <p className="text-gray-500 text-sm">
                Nessuna nota inserita per il lavoro eseguito
              </p>
            </div>
          )}
        </div>
