            ...
            <div className="space-y-2">
              {item.articles.map((article, idx) => (
                ...
                >
                  <div className="flex-1">
                    {(() => {
                      ...
                      const title =
                        ...
                        'Articolo';
                      const desc =
                        ad?.description || article.article_description;
                      return (
                        <>
                  ...
                  <div className="ml-3 text-sm text-gray-700 whitespace-nowrap">
                    Qt: {article.quantity}
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="text-gray-900">
                  {item.is_new_installation ? 'Sì' : 'No'}
                </div>
              </div>
              <div>
                <div className="text-sm font-medium text-gray-600 mb-1">
            ...
            {item.additional_services && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                ...
                <div className="text-gray-900">
                  {formatAdditionalServices(item.additional_services)}
                </div>
              </div>
            )}
