              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-600 flex-wrap mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    ID: {selectedGroup.assistance_intervention_id}
                  </span>
                </div>
                          ...
                          (quantityStatus.status === 'ECCESSO' ||
                            ...
                            <div className="mb-4 p-4 bg-white rounded border">
                              <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                  onClick={() =>
                                    onAddWarehouseAllocation(activity.id)
                                  }
                              ...
                              <div className="space-y-3">
                                {(warehouseAllocations[activity.id] || []).map(
                                  (allocation, index) => (
                                    <div
                                      key={index}
                                    ...
                                    >
                                      ...
                                      <div className="flex items-center gap-1 flex-shrink-0">
                                        ...
                                        <input
                                          type="number"
                                          min="1"
                                          max={getRequiredQuantity(activity)}
                              ...
                              <div className="">
                                <div className="text-sm text-gray-700">
                                  <div className="font-medium text-gray-900 mb-1">
                                    {quantityStatus.article.short_description}
                                  </div>
                                  <div className="flex items-center gap-2 text-xs text-gray-600">
                                    {quantityStatus.article.pnc_code && (
                                      <>
                                        <span>
                                          PNC: {quantityStatus.article.pnc_code}
                                        </span>
                                        <span>•</span>
                                      </>
                                    )}
                      ...
                      <div className="flex items-center gap-4 text-xs border-t border-gray-200 pt-3 text-gray-600">
                        ...
                        {activity.done_at && (
                          <div className="flex items-center gap-1">
                            <span>
                              Completata:{' '}
                              {new Date(activity.done_at).toLocaleDateString(
                                'it-IT'
                              )}
                            </span>
                          </div>
            ...
            <div className="text-sm text-gray-600">
              {selectedGroup.pendingActivities > 0 ? (
                <span className="text-orange-600">
                  {selectedGroup.pendingActivities} attività ancora da
                  completare
                </span>
              ) : (
